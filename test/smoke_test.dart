...
import 'package:state_restoration_hook/state_restoration_hook.dart';
        ...
        restoreState: (oldBucket, initial, restore) {
          ...
          if (initial && counter.value != 0) {
            WidgetsBinding.instance.addPostFrameCallback(
                  ...
                  SnackBar(
                    content: Text('Restored counter to ${counter.value}'),
                  ),
                ));
          }
        });
...
void main() {
  testWidgets('Counter restores state test', (WidgetTester tester) async {
